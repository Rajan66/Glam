                    ...
                    <div className=' flex gap-x-2 h-[36px] text-sm'>
                        ...
                        <div className='flex flex-1 max-w-[100px] 
                         items-center h-full border text-black font-medium'>
                            ...
                            {/* amount */}
                            <div className='h-full flex justify-center items-center px-2'>1</div>
                            {/* plus icon */}
                            <div className='flex-1 h-full flex justify-center items-center cursor-pointer'>
                                <IoMdAdd />
                            </div>
                        ...
                        {/* final price */}
                        <div className='flex-1 flex justify-end items-center text-black font-medium'>{`Rs. ${parseFloat(price * 1).toFixed(2)}`}</div>
                    </div>
                </div>
            </div>
        </div>
